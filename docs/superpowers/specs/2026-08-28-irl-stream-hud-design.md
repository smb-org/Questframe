...
> **Nachtrag (2026-08-30):** Diese Entscheidung wurde später bewusst revidiert: Der Token gehört dem Kanal, daher müssen alle berechtigten Editor:innen darauf zugreifen können. Der aktuelle Zustand ist in [docs/ARCHITECTURE.md](../../ARCHITECTURE.md) dokumentiert.
