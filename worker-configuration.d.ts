/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 12590b26549b9160a8058adc42d31506)
// Runtime types generated with workerd@1.20260828.1 2026-08-28 nodejs_compat
interface __BaseEnv_Env {
	OVERLAY_CAPSULE_LIMITER: RateLimit;
	OVERLAY_TOKEN_LIMITER: RateLimit;
	ASSETS: Fetcher;
	APP_ENV: "staging" | "production" | "local";
	RELEASE_STAGE: "v1a" | "v1b";
	TWITCH_CLIENT_ID: "SET_STAGING_TWITCH_CLIENT_ID" | "SET_PRODUCTION_TWITCH_CLIENT_ID" | "local-twitch-client-id";
	BROADCASTER_ID: "SET_STAGING_BROADCASTER_ID" | "SET_PRODUCTION_BROADCASTER_ID" | "12345678901234567890";
	PUBLIC_ORIGIN: "SET_STAGING_PUBLIC_ORIGIN" | "SET_PRODUCTION_PUBLIC_ORIGIN" | "http://localhost:5173";
	CAPSULE_ID: "irl-stream-hud-staging" | "irl-stream-hud" | "irl-stream-hud-local";
	CAPSULE_NAME: "IRL Stream HUD Staging" | "IRL Stream HUD" | "IRL Stream HUD Local";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		APP_ENV: "staging";
		RELEASE_STAGE: "v1a";
		TWITCH_CLIENT_ID: "SET_STAGING_TWITCH_CLIENT_ID";
		BROADCASTER_ID: "SET_STAGING_BROADCASTER_ID";
		PUBLIC_ORIGIN: "SET_STAGING_PUBLIC_ORIGIN";
		CAPSULE_ID: "irl-stream-hud-staging";
		CAPSULE_NAME: "IRL Stream HUD Staging";
		TIMEZONE: "Europe/Berlin";
		CHANNEL: DurableObjectNamespace<import("./src/worker/index").ChannelObject>;
	}
	interface ProductionEnv {
		...
		APP_ENV: "production";
		RELEASE_STAGE: "v1a";
		TWITCH_CLIENT_ID: "SET_PRODUCTION_TWITCH_CLIENT_ID";
		BROADCASTER_ID: "SET_PRODUCTION_BROADCASTER_ID";
		PUBLIC_ORIGIN: "SET_PRODUCTION_PUBLIC_ORIGIN";
		CAPSULE_ID: "irl-stream-hud";
		CAPSULE_NAME: "IRL Stream HUD";
		TIMEZONE: "Europe/Berlin";
		CHANNEL: DurableObjectNamespace<import("./src/worker/index").ChannelObject>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "RELEASE_STAGE" | "TWITCH_CLIENT_ID" | "BROADCASTER_ID" | "PUBLIC_ORIGIN" | "CAPSULE_ID" | "CAPSULE_NAME" | "TIMEZONE">> {}
}
